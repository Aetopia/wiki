...
Unlike addons, native mods directly interface with the Minecraft's memory and code. This (theoretically) gives you full control over *everything* happening inside the game.
...
This guide will only work on x64 Windows.
...
Signatures are also sometimes called patterns.

## Where Do I Start?

Now that you've learned some basic concepts about native modding, you're ready to start the guide! Next you'll set up an appropriate development environment.
